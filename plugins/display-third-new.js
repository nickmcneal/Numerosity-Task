...
jsPsych.plugins["display-third-new"] = (function () {
    ...
    plugin.trial = function (display_element, trial) {
      ...
      var display_stage = function () {
        ...
        new_html += '<div class="container-multi-choice-column" id= "multiattribute-choices-stimulus-left" style ="position:fixed; TOP:50%; LEFT:50%; transform: translate(-50%, -50%); line-height: 0" >';
        new_html += `<div id="multiattribute-choices-stimulus-left" ><img style = "HEIGHT:300px; WIDTH:300px" src="${trial.stimulus[0]}"/></div>`;
        new_html += '</div>';
        new_html += '<div class="container-multi-choice-column" id= "multiattribute-choices-stimulus-right" style="position:fixed; TOP:50%; LEFT:50%; transform: translate(-50%, -50%); line-height: 0">';
        new_html += `<div id="multiattributea-choices-stimulus-right" ><img style = "HEIGHT:300px; WIDTH:300px" src="${trial.stimulus[1]}"/ ></div>`;
        new_html += '</div>';
      ...
      var display_selection = function () {
        ...
        //$(seleted)c.css('border', `12px solid ${selected_color}`);
      };
